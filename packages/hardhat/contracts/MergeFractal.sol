...
contract MergeFractal is ERC721, Ownable {
  ...
  uint8[4] internal startBitCols = [50, 56, 62, 68];
  ...
  // Uses 6 random bits
  function renderLines(uint256 id, uint8 arraySection, uint8 startBit, string memory maxAngleText) public view returns (string memory) {
    string memory rgba = getRGBA(id, startBit, arraySection, "0.99");
  ...
  function renderDiskAndLines(uint256 id) public view returns (string memory) {
    ...
    render = string(abi.encodePacked(
      // render,
      renderDisk(id, startBitCols[3]),
      renderLines(id, 0, startBitCols[0], "-270"),
      renderLines(id, 1, startBitCols[1], "270"),
      renderLines(id, 2, startBitCols[2], "-180"),
      renderLines(id, 3, startBitCols[3], "180")
    ));
    return render;    
  }
  ...
  function renderBorder(uint256 id) public view returns (string memory) {
    ...
    //   renderLines(id, 1, 56, "270"),
    //   renderLines(id, 2, 62, "-180"),
